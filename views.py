...
from .model_source import sourceData
...
@login_required
def summary():
    return render_template('summary.html', hotelDetails=hotelDetails(), summaryCA=summaryCA())
...
@login_required
def source():
    return render_template("source.html", hotelDetails=hotelDetails(), sourceData=sourceData())
