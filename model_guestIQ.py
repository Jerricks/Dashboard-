...
def guestData():
    ...
    if customerData:
            ...
            for device in deviceId:
                ...
                if deviceData:
                    ...
                    if socialData:
                        ...
                        userPic = "http://graph.facebook.com/" + socialData[0]["provider_user_id"] + "/picture?type=large"
                    ...
                    for past in historyData:
                        ...
                        customer_category_data = list(DATABASE.customer_categories.find({"_id": ObjectId(customer_category_id)}))
                    ...
                    data.append({"phoneNo":phoneNo,"userName":userName,"userPic":userPic,"userEmail":userEmail,"userGender":userGender, "userHometown":userHometown ,"notesData":sug_data,"historyData":df4})
        else:
        ...
        data.append({"phoneNo": "None", "userName": "None", "userPic": "/static/images/anonymous-user.jpeg" , "userEmail": "None",
                     "userGender": "None", "userHometown": "None", "notesData": "", "historyData": pd.DataFrame()})
    return data
